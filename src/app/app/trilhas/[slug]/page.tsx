...
import { ArrowLeft, CheckCircle2, Circle, FileText, HelpCircle, PlayCircle } from "lucide-react";
  ...
  return (
    <main className="academy-app">
      <div className="academy-content">
        <Link href="/app/trilhas" className="academy-login-back"><ArrowLeft size={15} /> Todas as trilhas</Link>

        <div className="academy-welcome" style={{ marginTop: 18 }}>
          <div>
